...
.virtual('last10.asr')
.get(function() {
  return this.last10.attempts > 0 ? (this.last10.answers/this.last10.seizures).toFixed(1) : null ;
}); 
TrunkStatsSchema
.virtual('last10.acd')
.get(function() {
...
.virtual('last30.asr')
.get(function() {
  return this.last30.attempts > 0 ? (this.last30.answers/this.last30.seizures).toFixed(1) : null ;
}); 
TrunkStatsSchema
.virtual('last30.acd')
.get(function() {
...
.virtual('last60.asr')
.get(function() {
  return this.last60.attempts > 0 ? (this.last60.answers/this.last60.seizures).toFixed(1) : null ;
}); 
TrunkStatsSchema
.virtual('last60.acd')
.get(function() {
