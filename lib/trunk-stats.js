...
.virtual('last10.asr')
.get(function() {
  return this.last10.seizures > 0 ? (this.last10.answers*100/this.last10.seizures) : null ;
}); 
TrunkStatsSchema
.virtual('last10.acd')
.get(function() {
...
.virtual('last30.asr')
.get(function() {
  return this.last30.seizures > 0 ? (this.last30.answers*100/this.last30.seizures) : null ;
}); 
TrunkStatsSchema
.virtual('last30.acd')
.get(function() {
...
.virtual('last60.asr')
.get(function() {
  return this.last60.seizures > 0 ? (this.last60.answers*100/this.last60.seizures) : null ;
}); 
TrunkStatsSchema
.virtual('last60.acd')
.get(function() {
